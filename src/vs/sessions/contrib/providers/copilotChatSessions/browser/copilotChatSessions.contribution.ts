...
import { CopilotChatSessionsProvider, AI_STUDIO_MULTI_CHAT_SETTING, CLAUDE_CODE_ENABLED_SETTING } from '../../copilotChatSessions/browser/copilotChatSessionsProvider.js';
...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	id: 'sessions',
	properties: {
		[AI_STUDIO_MULTI_CHAT_SETTING]: {
			type: 'boolean',
			default: true,
			tags: ['preview'],
			description: localize('sessions.aiStudio.multiChatSessions', "Whether to enable multiple chats within a single session in the AI Studio Chat sessions provider."),
		},
		[CLAUDE_CODE_ENABLED_SETTING]: {
			type: 'boolean',
			default: true,
			experiment: { mode: 'startup' },
			description: localize('sessions.chat.claudeAgent.enabled', "Enable Claude Agent sessions in the Agents window. Start and resume agentic coding sessions powered by Anthropic's Claude Agent SDK directly. Uses your existing AI Studio subscription."),
		},
	},
});
