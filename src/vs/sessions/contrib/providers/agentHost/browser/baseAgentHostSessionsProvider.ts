...
/** AI Studio CLI session type */
export const CopilotCLISessionType: ISessionType = {
	id: 'aiStudioCli',
	label: localize('aiStudioCLI', "AI Studio CLI"),
...
export interface IAgentHostAdapterOptions {
	 ...
	 * resolvers. Shared with the AI Studio chat sessions provider so all
...
export abstract class BaseAgentHostSessionsProvider extends Disposable implements IAgentHostSessionsProvider {
	...
	/** Format the human-readable label for a session type entry (e.g. `AI Studio [Local]`). */
