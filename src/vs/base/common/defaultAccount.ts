...
export interface IEntitlementsData extends ILegacyQuotaSnapshotData {
	...
	readonly limited_user_reset_date?: string; 	// for AI Studio Free
	readonly quota_reset_date?: string; 		// for all other AI Studio SKUs
	readonly quota_reset_date_utc?: string; 	// for all other AI Studio SKUs (includes time)
	readonly token_based_billing?: boolean;
