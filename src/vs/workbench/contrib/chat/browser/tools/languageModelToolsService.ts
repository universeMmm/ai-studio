	...
	constructor(
		...
		this.vscodeToolSet = this._register(this.createToolSet(
			...
			VSCodeToolReference.vscode,
			{
				...
				description: localize('aiStudio.toolSet.vscode.description', 'Use VS Code features'),
			}
		));
		...
		this.executeToolSet = this._register(this.createToolSet(
			...
			SpecedToolAliases.execute,
			{
				...
				description: localize('aiStudio.toolSet.execute.description', 'Execute code and applications on your machine'),
			}
		));
		...
		this.readToolSet = this._register(this.createToolSet(
			...
			SpecedToolAliases.read,
			{
				...
				description: localize('aiStudio.toolSet.read.description', 'Read files in your workspace'),
			}
		));
		...
		this.agentToolSet = this._register(this.createToolSet(
			...
			SpecedToolAliases.agent,
			{
				...
				description: localize('aiStudio.toolSet.agent.description', 'Delegate tasks to other agents'),
			}
		));
	}
