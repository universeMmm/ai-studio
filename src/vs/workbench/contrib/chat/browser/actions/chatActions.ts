	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('manageChat', "Manage AI Studio Settings"),
				category: CHAT_CATEGORY,
				f1: true,
				precondition: ContextKeyExpr.and(
					ContextKeyExpr.or(
	...
	registerAction2(class ShowExtensionsUsingCopilot extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize2('showAiStudioUsageExtensions', "Show Extensions using AI Studio"),
				f1: true,
	...
	registerAction2(class ShowQuotaExceededDialogAction extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize('upgradeChat', "Upgrade AI Studio Plan")
			});
		}
		...
		override async run(accessor: ServicesAccessor) {
			...
			const upgradeToPro = free ? localize('upgradeToPro', "Upgrade to AI Studio Pro for:\n- Unlimited inline suggestions\n- Unlimited chat messages\n- Access to premium models") : undefined;

			await dialogService.prompt({
				type: 'none',
				message: localize('aiStudioQuotaReached', "AI Studio Quota Reached"),
				cancelButton: {
				...
				buttons: [
					{
						label: free ? localize('upgradePro', "Upgrade to AI Studio Pro") : localize('upgradePlan', "Upgrade AI Studio Plan"),
						run: () => {
