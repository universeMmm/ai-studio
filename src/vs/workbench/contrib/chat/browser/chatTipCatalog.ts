	...
	},
	{
		...
		buildMessage() {
			return new MarkdownString(
				localize(
					'tip.copilotCli',
					"Run agents in parallel with [AI Studio CLI](command:workbench.action.chat.openNewChatSessionInPlace.copilotcli?%5B%22sidebar%22%5D \"Switch to AI Studio CLI\")."
				)
			);
		},
		when: ContextKeyExpr.and(
