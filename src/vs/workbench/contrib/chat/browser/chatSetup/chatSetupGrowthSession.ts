...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try AI Studio"),
			description: localize('growthSession.description', "AI Studio is available. Try it for free."),
