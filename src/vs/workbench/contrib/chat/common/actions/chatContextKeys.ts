...
export namespace ChatContextKeys {
	...
	export const nonBuiltInLanguageModelsAreUserSelectable = new RawContextKey<boolean>('chatNonAiStudioModelsAreUserSelectable', false, { type: 'boolean', description: localize('chatNonAiStudioModelsAreUserSelectable', "True when a user-selectable chat model from a non-AI Studio vendor is available.") });
	...
	export const newChatButtonExperimentIcon = new RawContextKey<string>('chatNewChatButtonExperimentIcon', '', { type: 'string', description: localize('chatNewChatButtonExperimentIcon', "The icon variant for the new chat button, controlled by experiment. Values: 'ai-studio', 'new-session', 'comment', or empty for default.") });
}
