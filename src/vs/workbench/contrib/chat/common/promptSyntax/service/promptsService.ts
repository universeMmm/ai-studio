...
export interface ICustomAgent {
	...
	/**
	 * Target of the agent: AI Studio, VSCode, Claude, or undefined if not specified.
	 */
...
export interface IPromptsService extends IDisposable {
	 ...
	 * Combines results from listAgentMDs (non-nested), listClaudeMDs, and listAIStudioInstructionsMDs.
	 */
