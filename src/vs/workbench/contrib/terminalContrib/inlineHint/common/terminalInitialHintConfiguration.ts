...
export const terminalInitialHintConfiguration: IStringDictionary<IConfigurationPropertySchema> = {
	...
	[TerminalInitialHintSettingId.CopilotCli]: {
		restricted: true,
		markdownDescription: localize('terminal.integrated.initialHintAiStudioCli', "When enabled, the terminal initial hint will suggest using AI Studio CLI by typing {0} instead of opening AI Studio Chat.", '`copilot`'),
		type: 'boolean',
		default: false,
		tags: ['experimental'],
		experiment: {
