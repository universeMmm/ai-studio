...
import { AgentHostSlashCommandCompletionProvider, parseLeadingSlashCommand } from '../../node/copilot/copilotSlashCommandCompletionProvider.js';

suite('AgentHostSlashCommandCompletionProvider', () => {
	...
	suite('provideCompletionItems', () => {
		const provider = new AgentHostSlashCommandCompletionProvider('copilotcli');
		...
		test('omits /compact when session has no history', async () => {
			const gated = new AgentHostSlashCommandCompletionProvider('copilotcli', { hasHistory: () => false });
		...
		test('passes raw session id (no scheme/slash) to hasHistory', async () => {
			...
			const gated = new AgentHostSlashCommandCompletionProvider('copilotcli', {
