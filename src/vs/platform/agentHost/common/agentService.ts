...
/** Configuration key that controls whether Agent Host uses its terminal tool override for AI Studio SDK sessions. */
 ...
 * AI Studio bearer token (e.g. Copilot CLI, Claude) so they advertise an
...
/**
 * Implemented by each agent backend (e.g. AI Studio SDK).
...
export interface IAgentService {
	...
	/** List all available sessions from the AI Studio CLI. */
	listSessions(): Promise<IAgentSessionMetadata[]>;
