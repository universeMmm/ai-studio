...
export interface IAgentHostSessionContext {
	readonly cwd?: string;
...
export async function projectFromAgentContext(context: IAgentHostSessionContext | undefined, gitService: IAgentHostGitService): Promise<IAgentSessionProjectInfo | undefined> {
