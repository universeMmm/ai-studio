...
/**
 * Attribute keys emitted by the AI Studio CLI SDK's native OTel instrumentation
 * (read by the bridge processor; the host itself does not produce these).
 */
export const CopilotCliSdkAttr = {
	HOOK_TYPE: 'aiStudio.hook.type',
	HOOK_INVOCATION_ID: 'aiStudio.hook.invocation_id',
} as const;
